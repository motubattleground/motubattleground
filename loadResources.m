function [images, audio] = loadResources()
    ...
    images.field1 = imresize(imread('images\buttons\campo1.png'), [80, 400]);
    images.field2 = imresize(imread('images\buttons\campo2.png'), [80, 400]);
    images.field3 = imresize(imread('images\buttons\campo3.png'), [80, 400]);
    images.field4 = imresize(imread('images\buttons\campo4.png'), [80, 400]);
    images.field5 = imresize(imread('images\buttons\campo5.png'), [80, 400]);
    images.field6 = imresize(imread('images\buttons\campo6.png'), [80, 400]);
    images.field1_1j_a = imresize(imread('images\buttons\campo1_1j_a.png'), [80, 400]);
    images.field2_1j_a = imresize(imread('images\buttons\campo2_1j_a.png'), [80, 400]);
    images.field3_1j_a = imresize(imread('images\buttons\campo3_1j_a.png'), [80, 400]);
    images.field4_1j_a = imresize(imread('images\buttons\campo4_1j_a.png'), [80, 400]);
    images.field5_1j_a = imresize(imread('images\buttons\campo5_1j_a.png'), [80, 400]);
    images.field6_1j_a = imresize(imread('images\buttons\campo6_1j_a.png'), [80, 400]);
    images.field1_1j_b = imresize(imread('images\buttons\campo1_1j_b.png'), [80, 400]);
    images.field2_1j_b = imresize(imread('images\buttons\campo2_1j_b.png'), [80, 400]);
    images.field3_1j_b = imresize(imread('images\buttons\campo3_1j_b.png'), [80, 400]);
    images.field4_1j_b = imresize(imread('images\buttons\campo4_1j_b.png'), [80, 400]);
    images.field5_1j_b = imresize(imread('images\buttons\campo5_1j_b.png'), [80, 400]);
    images.field6_1j_b = imresize(imread('images\buttons\campo6_1j_b.png'), [80, 400]);
    images.field1_2j_a = imresize(imread('images\buttons\campo1_2j_a.png'), [80, 400]);
    images.field2_2j_a = imresize(imread('images\buttons\campo2_2j_a.png'), [80, 400]);
    images.field3_2j_a = imresize(imread('images\buttons\campo3_2j_a.png'), [80, 400]);
    images.field4_2j_a = imresize(imread('images\buttons\campo4_2j_a.png'), [80, 400]);
    images.field5_2j_a = imresize(imread('images\buttons\campo5_2j_a.png'), [80, 400]);
    images.field6_2j_a = imresize(imread('images\buttons\campo6_2j_a.png'), [80, 400]);
    images.field1_2j_b = imresize(imread('images\buttons\campo1_2j_b.png'), [80, 400]);
    images.field2_2j_b = imresize(imread('images\buttons\campo2_2j_b.png'), [80, 400]);
    images.field3_2j_b = imresize(imread('images\buttons\campo3_2j_b.png'), [80, 400]);
    images.field4_2j_b = imresize(imread('images\buttons\campo4_2j_b.png'), [80, 400]);
    images.field5_2j_b = imresize(imread('images\buttons\campo5_2j_b.png'), [80, 400]);
    images.field6_2j_b = imresize(imread('images\buttons\campo6_2j_b.png'), [80, 400]);
    images.goodSide = imresize(imread('images\buttons\bandodelbien.png'), [80, 400]);
    images.evilSide = imresize(imread('images\buttons\bandodelmal.png'), [80, 400]);
